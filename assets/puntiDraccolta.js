...
const turinLocations = [
  ...
  {
    location: 'Turin Olympic Park',
    description: 'A large park located in the western suburbs of Turin, built for the 2006 Winter Olympics and now used for various recreational activities and events.',
    coordinates: { lat: 45.06755, lng: 7.62094 },
    distance: 4.0,
    driveDuration: 4.0,
    startingAddr: '',
    destinationAddr: '',
